...
from MedicalItemExtraction import MedicalItemExtraction
...
keyword = MedicalItemExtraction(keyword_name, is_train = option.is_train, is_output = option.is_output, cuda = option.cuda)
