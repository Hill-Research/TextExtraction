...
class CriteriaExtraction(object):
    """
    ...
    def __init__(self, name, is_train = False, is_output = False, cuda = False):
        ...
        option_extraction.tag2id = {"ELSE" : 0, "NAME" : 1, "NUMBER" : 2, "[CLS]" : 3, "[SEP]" : 4}
        option_extraction.id2tag = ["ELSE", "NAME", "NUMBER", "[CLS]", "[SEP]"]
        option_extraction.type = "{}_criteria_extraction".format(name)
